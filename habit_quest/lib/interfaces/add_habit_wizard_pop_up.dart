...
class _AddHabitWizardPopUpState extends State<AddHabitWizardPopUp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Focus(
        focusNode: TutorialManager.wizardPanelNode,
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    // THE NATIVE HANDSHAKE — wizard's own button advances
                    // the tutorial. Steps 4/5/6 are NOT in stepsRequiringNextButton
                    // precisely because this call handles the advance.
                    ...
                    if (context.mounted) {
                      ...
                      // Placeholder SnackBar removed — no longer shows
                      // "Placeholder: New Habit Saved" during the tutorial.
                    }
                  },
                  child:
