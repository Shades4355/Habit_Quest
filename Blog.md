...
Friday, April 10th, Miguel and Shades had an extra meeting to discuss User Feedback on the idea of including a cloud backup feature. The Users who participated in the User Testing all resoundingly felt like that would be a mistake. As such, we are not going ahead with that feature.

Since last week, Shades has completed the User Testing and written and submitted the associated report.

Miguel, has been working on the export feature, including fixing the formatting to be in such a way as to allow us to import it in the future.

In this meeting, we discussed the new tasks generated by the User Testing.

This week, Marvens will work on replacing the “placeholder” text in the app, as well as replacing the snackbar notifications with a more user friendly implementation.

Miguel will finish up the export feature, and will start the import feature.
